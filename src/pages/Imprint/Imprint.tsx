  ...
  return (
    <Box textAlign="center" minHeight="100vh" sx={{ py: 2 }}>
      ...
      <ImprintContent>
        <>Angaben gemäß §5 TMG</>
        <>
          <Typography>Max Janorschke</Typography>
          <Typography>Weizenweg 20</Typography>
          <Typography>52134 Herzogenrath</Typography>
        </>
      </ImprintContent>
      ...
      <ImprintContent>
        <>Kontakt</>
        <>
          <Typography>Telefon: 015733226868</Typography>
          <Typography>
            E-Mail: <MailLink email="webmaster@max-janorschke.de" />
          </Typography>
        </>
      </ImprintContent>
